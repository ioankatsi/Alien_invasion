...
def check_keydown_events(event, ai_settings, screen, stats, play_button, ship, aliens,
			 bullets):
...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets):
	...
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			...
			check_keydown_events(event, ai_settings, screen, stats, play_button, ship, aliens,
			 bullets)
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
	 play_button):
	"""Update images on the screen amd flip to the new screen."""
	# Redraw the screen during each pass throush the loop.
	screen.fill(ai_settings.bg_color)
	# Redraw all bulelts behind ship and aliens
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
	...
	# Look for aliens hitrting the bottom of the screen.
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
	""" Check if any aliens have reached the botttom of the screen. """
